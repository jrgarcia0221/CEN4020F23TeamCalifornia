...
def buildMenu():
    root =  menuSystem.menuNode("Main Menu", children=[
                menuSystem.menuNode("Create an account", action=createAccount),
                menuSystem.menuNode("Login", goBack=True, action=login, children=[
                    menuSystem.menuNode("Find Someone you know", goBack=True, action=studentLookup),
                    menuSystem.menuNode("Job search / internship", goBack=True, action=jobSearchAction, children=[
                        menuSystem.menuNode("Post a job", goBack=True, action=postJobAction)
            ]),            
        ]),
        menuSystem.menuNode("Student Lookup", goBack=True, action=studentLookup),
        menuSystem.menuNode("Look for inCollege Friends", goBack=True),
        menuSystem.menuNode("Watch video on why you should join InCollege!",action=watchVideo, goBack=True),
